...
The first option I immediately ruled out, 4 GB RAM in 2025 would be an interesting experience to say the least, alongside the 4 core Intel Pentium processor (probably haven't heard that name in a while...)
...
for media streaming or something, and upgradable RAM.
...
The installer wouldn't connect to my home Wi-Fi, and the laptop has an ethernet port but I have no way to connect it because I live in a dorm that was built in the last 5 years. So I decided to continue without it, thinking I could connect when the OS was installed.
...
So I re-flashed the USB with a Debian 13 image, plugged it in, and booted up the laptop. Going through the installer everything was working but then I got to the moment of truth: Network Setup. Holding my breath, I selected my Wi-Fi, inputted my password and click connect. A few moments later, it connected. No hassle. No need for dependencies. No missing drivers for the network card. It. Just. Worked.
